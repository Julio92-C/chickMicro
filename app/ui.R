  ...
  dashboardBody(
    ...
    tabItems(
      tabItem(tabName = "home",
              h1("Welcome to chickMicro"),
              h2("This is a web application to explore the poultry gut microbiome"),
                                    ...
                                    fluidRow(
                                      ...
                                      column(6,
                                             ...
                                             box(
                                               ...
                                               status = "teal",
                                               solidHeader = TRUE,
                                               title = "Impact of Dulse (a protein-rich red seaweed) on poultry gut microbiome",
                                              ...
                                              genomic diversity and population structure analysis of the poultry gut microbiome."),
                                               
                                               tags$p("The application is designed
                                              to provide a user-friendly interface for researchers and stakeholders to analyze
                                              and visualize the metagenomic data generated from the poultry production procces."),
